<?php
    ...
    if (!isset($_GET['u']) || !isset($_GET['p'])) {
        ...
        $encodedReturn = urlencode($currentUrl);
        ...
        //header("Location: " . $onlineServer . "prep-hotspot-login?r=" . $encodedReturn);
        header("Location: " . $url);
...
<body>
    ...
    <form method="post" action="$PORTAL_ACTION$" id="login_form">
        <input type="hidde" name="auth_user" value="<?= $username ?>">
        <input type="hidde" name="auth_pass" value="<?= $password ?>">
